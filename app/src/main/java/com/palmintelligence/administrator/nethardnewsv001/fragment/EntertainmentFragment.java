 ...
 */
public class EntertainmentFragment  extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener, MyRecyclerView.LoadingData, BaseRecyclerViewAdapter.OnItemClickListener<GamesBean>,
        BaseView<GamesBean> { private SwipeRefreshLayout srfLayout;
    ...
    protected void initData() {
        ...
        Log.i("EntertainmentFragment","initData()");
    ...
    public void onItemClick(View view, int position, GamesBean info) {
        ...
        Log.i("EntertainmentFragment","onItemClick被调用了");
    }
