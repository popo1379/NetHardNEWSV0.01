 ...
 */
public class ChinaFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener, MyRecyclerView.LoadingData, BaseRecyclerViewAdapter.OnItemClickListener<GamesBean>,
        BaseView<GamesBean> {
    ...
    public void onItemClick(View view, int position, GamesBean info) {
        ...
        Log.i("ChinaFragment","onItemClick被调用了");
    }
}
