 ...
 */
public class SportFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener, MyRecyclerView.LoadingData, BaseRecyclerViewAdapter.OnItemClickListener<GamesBean>,
        BaseView<GamesBean> {
    ...
    public void onItemClick(View view, int position, GamesBean info) {
        ...
        Log.i("SportFragment","onItemClick被调用了");
    }
