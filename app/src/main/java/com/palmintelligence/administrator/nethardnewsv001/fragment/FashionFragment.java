 ...
 */
public class FashionFragment  extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener, MyRecyclerView.LoadingData, BaseRecyclerViewAdapter.OnItemClickListener<GamesBean>,
        BaseView<GamesBean> {
    ...
    protected void initData() {
        ...
        Log.i("FashionFragment","initData()");
